...
module.exports = (app) => {
    ...
    app.delete("/form/deleteuser", async (req, res) => controllerAuth.deleteUser(req, res));
    // app.get("/form/test", async (req, res) => controllerAuth.test(req, res));
    ...
    app.delete("/form/deleteform", async (req, res) => controllerForm.deleteForm(req, res));
